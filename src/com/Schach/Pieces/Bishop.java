...
public class Bishop extends Piece {
    ...
    private static final int[] POSSIBLE_MOVE_VECTORCOORDINATES = {-9, -7, 7, 9}; //Possible moves according to the current position of the piece
            ...
            while(BoardUtils.isValidTileCoordinate(candidateDestinationCoordindate)) {
                ...
                if(BoardUtils.isValidTileCoordinate(candidateDestinationCoordindate)) {
                    ...
                    if(!candidateDestinationTile.isSquareOccupied()) {
                        legalMoves.add(new Move.NormalMove(board,this, candidateDestinationCoordindate)); //the bishop performs a legal move
